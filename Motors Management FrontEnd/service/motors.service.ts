...
export class MotorsService {
  apiURL: string = "http://localhost:9191/motors-service/motors/api/all";
  apiURLTyp: string = "http://localhost:9191/motors-service/motors/api/typ";
  apiURL3:string="http://localhost:9191/motors-service/motors/api/image/uplaodImageMotor/id";
  apiURL4:string="http://localhost:9191/users-service/users"
